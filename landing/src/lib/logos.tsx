...
// Claude's clay mark). Rendered via innerHTML so the originals' hyphenated SVG
// attributes survive untouched. The content is static and trusted.
function Brand({ id }: { id: keyof typeof BRAND_SVGS }) {
  const b: Brand = BRAND_SVGS[id];
  return (
    <svg
      viewBox={b.vb}
      className="size-full"
...
export const GmailLogo = () => <Brand id="gmail" />;
export const CalendarLogo = () => <Brand id="calendar" />;
export const KeepLogo = () => <Brand id="keep" />;
export const GoogleLogo = () => <Brand id="google" />;
export const AnthropicLogo = () => <Brand id="claude" />;
export const OpenRouterLogo = () => <Brand id="openrouter" />;

// OpenAI's official mark is monochrome — render in the theme colour so it stays
// visible in both light and dark.
export const OpenAILogo = () => (
  <svg role="img" viewBox="0 0 24 24" fill="currentColor" className="size-full">
    <title>OpenAI</title>
...
export const PROVIDERS: LogoItem[] = [
  { name: "Anthropic", Logo: AnthropicLogo },
  { name: "OpenAI", Logo: OpenAILogo },
  { name: "Google", Logo: GoogleLogo },
  { name: "OpenRouter", Logo: OpenRouterLogo },
  { name: "Local", Logo: LocalLogo },
];

export const ECOSYSTEM: LogoItem[] = [
  { name: "Gmail", Logo: GmailLogo },
  { name: "Contacts", Logo: ContactsLogo },
  { name: "Google Keep", Logo: KeepLogo },
