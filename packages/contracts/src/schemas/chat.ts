...
export const ChatEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("tool-call"), toolCallId: z.string().optional(), toolName: z.string(), input: z.unknown() }),
  z.object({ type: z.literal("tool-result"), toolCallId: z.string().optional(), toolName: z.string(), output: z.unknown() }),
  z.object({ type: z.literal("graph"), nodes: z.array(GraphNodeSchema), links: z.array(GraphLinkSchema) }),
